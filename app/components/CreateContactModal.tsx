...
const CreateContactModal = () => {
  ...
  return (
    <div>
      <button onClick={onOpen} className="py-2 px-3 w-[180px] bg-primary rounded shadow-md text-white">Add Contact </button>
              ...
              <ModalBody>
                <div className='mb-3'>
                  <div className="relative space-y-5">
                    <input type="text" placeholder="Full Name" aria-label="Full Name" className="block focus:outline-none w-full bg-secondary-bg rounded-md py-3 pl-6 pr-20" />
                    
                    <input type="email" placeholder="Email" aria-label="Email" className="block focus:outline-none w-full bg-secondary-bg rounded-md py-3 pl-6 pr-20" />
